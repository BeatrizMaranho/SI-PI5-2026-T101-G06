...
!rm -rf /content/dataset_final_yolo2
!unzip -q /content/drive/MyDrive/PI_V/dataset_final_yolo2.zip -d /content/
...
model = YOLO('/content/runs/detect/treino_melhorado2/weights/best.pt')
